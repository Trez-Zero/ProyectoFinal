...
//   - Sin clases (salvo la contenedora Program), sin herencia, sin List<T>.
//   - Solo structs, arreglos de tamano fijo y metodos estaticos.
//
//  MEJORAS DE JUGABILIDAD (v2) - marcadas con // NUEVO:
//   1. Economia de mana: el Zarpazo recupera mana; las habilidades lo gastan.
//   2. Curar util: enemigos mas duros, enojo bajo 30% HP, jefe con golpe cargado.
//   3. Huir con sentido: salis a usar objetos, pero el enemigo se cura del todo.
//   4. Habilidades con efectos distintos (debuff, critico, golpe pesado).
//   5. Inventario de objetos (arreglos paralelos), se encuentran explorando.
//   6. Eventos aleatorios al explorar (trampas, fuentes, decisiones).
//   7. IA enemiga variada y jefe con fases.
// ============================================================================
